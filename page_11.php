...
<div class="row">
    ...
    <div class="col-xs-9">
        ...
        <script>
            document.write("<a class='thumbnail imagethumb' target='_blank' href='paper_image/page_image/" + getCookie("date") + "/11.png'>" +
                "<img src='paper_image/page_image/" + getCookie("date") + "/11.png' alt='বিজ্ঞাপন'/>" +
                "</a>");
        </script>
    </div>
    <div class="col-xs-3">
