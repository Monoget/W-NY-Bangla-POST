...
if(!isset($_COOKIE['date'])){
    ...
    header('location:নিউ_ইয়র্ক_বাংলা_পোস্ট-৬');
}
?>
<!DOCTYPE html>
<html>
...
<div class="row">
    ...
    <div class="col-xs-9">
        ...
        <a class="thumbnail imagethumb" target="_blank"
           href="paper_image/page_image/<?php echo $_COOKIE['date'].'/'; ?>6.png"><img
                    src="paper_image/page_image/<?php echo $_COOKIE['date'].'/'; ?>6.png"
                    alt=""/></a>
    </div>
    <div class="col-xs-3">
        <div class="seperator_15"></div>
