...
<html>
<head>
    <title>অপরাধ - নিউইয়র্ক বাংলা পোস্ট ইপেপার</title>
...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="title-header clearfix">
            ...
            <h2 class="title-heading f-light">অপরাধ</h2>

        </div>
        <div class="seperator_15"></div>
        <script>
            document.write("<a class='thumbnail imagethumb' target='_blank' href='paper_image/page_image/" + getCookie("date") + "/27.png'>" +
                "<img src='paper_image/page_image/" + getCookie("date") + "/27.png' alt='অপরাধ'/>" +
                "</a>");
        </script>
    </div>
    <div class="col-xs-3">
