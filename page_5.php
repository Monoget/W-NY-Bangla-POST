...
<html>
<head>
    <title>ব্যবসা বাণিজ্য - নিউইয়র্ক বাংলা পোস্ট ইপেপার</title>
...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="title-header clearfix">
            ...
            <h2 class="title-heading f-light">ব্যবসা বাণিজ্য</h2>
        ...
        <script>
            document.write("<a class='thumbnail imagethumb' target='_blank' href='paper_image/page_image/" + getCookie("date") + "/5.png'>" +
                "<img src='paper_image/page_image/" + getCookie("date") + "/5.png' alt='ব্যবসা বাণিজ্য'/>" +
                "</a>");
        </script>
    </div>
    <div class="col-xs-3">
