...
<div class="row">
    ...
    <div class="col-xs-9">
        ...
        <script>
            document.write("<a class='thumbnail imagethumb' target='_blank' href='paper_image/page_image/" + getCookie("date") + "/40.png'>" +
                "<img src='paper_image/page_image/" + getCookie("date") + "/40.png' alt='শেষের পাতা'/>" +
                "</a>");
        </script>
    </div>
    <div class="col-xs-3">
